...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M174780365-0', 'Olanzapine', 1, 32, 0, 0, to_date('2016-05-26', 'yyyy-mm-dd'), 'Romance', 1, '43-8426902');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M199313177-9', 'Satohap', 7, 81, 0, 0, to_date('2016-10-28', 'yyyy-mm-dd'), 'Science Fiction', 1, '43-8426902');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M374688018-1', 'Pravastatin Sodium', 2, 2, 0, 0, to_date('2016-06-06', 'yyyy-mm-dd'), 'Action', 1, '43-8426902');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M211487951-8', 'Activella', 6, 34, 0, 0, to_date('2016-05-13', 'yyyy-mm-dd'), 'Horror', 1, '50-4392985');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M488892791-X', 'Differin', 8, 92, 0, 0, to_date('2016-04-23', 'yyyy-mm-dd'), 'Horror', 1, '50-4392985');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M684103662-X', 'Clonazepam', 5, 13, 0, 0, to_date('2017-03-09', 'yyyy-mm-dd'), 'Action', 1, '84-1469852');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M190607278-7', 'Xalkori', 10, 95, 0, 0, to_date('2017-02-14', 'yyyy-mm-dd'), 'Science Fiction', 1, '84-1469852');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M233532223-0', 'Perphenazine', 4, 13, 0, 0, to_date('2016-07-14', 'yyyy-mm-dd'), 'Children', 1, '70-5831373');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M924122750-8', 'Hydrocodone Bitartrate And Acetaminophen', 1, 62, 0, 0, to_date('2017-03-01', 'yyyy-mm-dd'), 'Action', 1, '03-1059950');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M217992193-4', 'Methocarbamol', 1, 76, 0, 0, to_date('2016-12-31', 'yyyy-mm-dd'), 'Thriller', 1, '03-1059950');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M654261916-X', 'Omeprazole', 5, 31, 0, 0, to_date('2016-06-30', 'yyyy-mm-dd'), 'Romance', 1, '70-5831373');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M552063168-9', 'Neutrogena Rapid Wrinkle Repair Moisturizer', 5, 1, 0, 0, to_date('2017-02-18', 'yyyy-mm-dd'), 'Documentary', 1, '43-8426902');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M820207425-8', 'SEROQUEL', 8, 32, 0, 0, to_date('2016-12-29', 'yyyy-mm-dd'), 'Documentary', 1, '84-1469852');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M505705799-5', 'Infants Ibuprofen', 7, 71, 0, 0, to_date('2016-07-23', 'yyyy-mm-dd'), 'Thriller', 1, '70-5831373');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M287175663-5', 'SOUTHERN CHEAT CHESS POLLEN', 3, 69, 0, 0, to_date('2016-06-06', 'yyyy-mm-dd'), 'Romance', 1, '50-4392985');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M124228302-1', 'Junior Strength Acetaminophen', 3, 12, 0, 0, to_date('2017-03-20', 'yyyy-mm-dd'), 'Horror', 1, '43-8426902');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M919256288-4', 'Naproxen', 9, 1, 0, 0, to_date('2016-10-16', 'yyyy-mm-dd'), 'Science Fiction', 1, '50-4392985');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M179390592-4', 'PORK', 2, 7, 0, 0, to_date('2017-04-14', 'yyyy-mm-dd'), 'Documentary', 1, '03-1059950');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M450207868-9', 'AETHUSA CYNAPIUM', 2, 85, 0, 0, to_date('2017-03-12', 'yyyy-mm-dd'), 'Adventure', 1, '43-8426902');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M635243850-4', 'Arizona Ash', 8, 8, 0, 0, to_date('2016-05-06', 'yyyy-mm-dd'), 'Romance', 1, '43-8426902');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M411281165-9', 'NO-AD SPF4 Dark Tanning Oil', 7, 67, 0, 0, to_date('2016-11-25', 'yyyy-mm-dd'), 'Romance', 1, '03-1059950');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M211100485-5', 'Professional Therapy Muscle Care Pain Relieving Ointment', 5, 60, 0, 0, to_date('2016-09-27', 'yyyy-mm-dd'), 'Documentary', 0, null);
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M503453138-0', 'Petroleum', 1, 42, 0, 0, to_date('2017-03-10', 'yyyy-mm-dd'), 'Adventure', 1, '03-1059950');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M477233437-8', 'Saline Enema', 1, 89, 0, 0, to_date('2016-06-01', 'yyyy-mm-dd'), 'Documentary', 1, '50-4392985');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M854503307-9', 'careone milk of magnesia', 6, 48, 0, 0, to_date('2016-12-06', 'yyyy-mm-dd'), 'Adventure', 1, '43-8426902');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M660157314-0', 'Phentermine Hydrochloride', 8, 8, 0, 0, to_date('2016-07-03', 'yyyy-mm-dd'), 'Romance', 1, '50-4392985');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M712773188-8', 'Diphenhydramine HCL', 10, 9, 0, 0, to_date('2016-09-12', 'yyyy-mm-dd'), 'Children', 1, '70-5831373');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M052454358-5', 'Nitrous Oxide', 3, 70, 0, 0, to_date('2016-05-20', 'yyyy-mm-dd'), 'Action', 1, '84-1469852');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M148142096-8', 'Chlorhexidine Gluconate', 1, 23, 0, 0, to_date('2016-10-08', 'yyyy-mm-dd'), 'Action', 1, '50-4392985');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M405494574-0', 'Russian Thistle', 9, 79, 0, 0, to_date('2016-05-10', 'yyyy-mm-dd'), 'Documentary', 1, '84-1469852');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M187439060-6', 'Aspirin', 3, 76, 0, 0, to_date('2017-02-21', 'yyyy-mm-dd'), 'Horror', 1, '84-1469852');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M902935049-0', 'PARURE DE LUMIERE LIGHT-DIFFUSING FOUNDATION WITH SUNSCREEN', 1, 87, 0, 0, to_date('2017-03-16', 'yyyy-mm-dd'), 'Adventure', 1, '03-1059950');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M486843403-9', 'CALCAREA FLUORICA', 6, 95, 0, 0, to_date('2016-11-09', 'yyyy-mm-dd'), 'Horror', 1, '03-1059950');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M952545687-0', 'Childrens Earache Relief', 4, 62, 0, 0, to_date('2016-09-19', 'yyyy-mm-dd'), 'Children', 1, '70-5831373');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M891216517-8', 'Olive Pollen', 8, 6, 0, 0, to_date('2016-07-09', 'yyyy-mm-dd'), 'Children', 1, '43-8426902');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M660880559-4', 'Sisal', 4, 99, 0, 0, to_date('2016-12-07', 'yyyy-mm-dd'), 'Thriller', 1, '43-8426902');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M548194364-6', 'ARTISTRY IDEAL RADIANCE UV Protect SPF 50 PLUS Broad', 1, 9, 0, 0, to_date('2016-05-24', 'yyyy-mm-dd'), 'Adventure', 0, null);
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M495916945-1', 'Divalproex Sodium', 6, 52, 0, 0, to_date('2016-09-18', 'yyyy-mm-dd'), 'Science Fiction', 1, '50-4392985');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M898435796-0', 'CRESTOR', 5, 24, 0, 0, to_date('2016-05-18', 'yyyy-mm-dd'), 'Romance', 1, '70-5831373');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M412093618-X', 'LMD in Dextrose', 6, 47, 0, 0, to_date('2017-02-27', 'yyyy-mm-dd'), 'Science Fiction', 1, '43-8426902');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M235500150-2', 'Naprelan', 10, 3, 0, 0, to_date('2017-01-27', 'yyyy-mm-dd'), 'Romance', 1, '70-5831373');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M111592155-X', 'Vicks DayQuil', 6, 84, 0, 0, to_date('2017-02-18', 'yyyy-mm-dd'), 'Thriller', 1, '43-8426902');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M014609733-5', 'BareMinerals', 8, 64, 0, 0, to_date('2016-11-27', 'yyyy-mm-dd'), 'Documentary', 1, '43-8426902');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M417541592-0', 'Premier Value', 10, 64, 0, 0, to_date('2017-01-20', 'yyyy-mm-dd'), 'Children', 1, '84-1469852');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M502940406-6', 'Quetiapine fumarate', 6, 65, 0, 0, to_date('2016-04-19', 'yyyy-mm-dd'), 'Children', 1, '43-8426902');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M467080207-0', 'Alcohol-Free Anticavity', 2, 45, 0, 0, to_date('2017-04-11', 'yyyy-mm-dd'), 'Romance', 1, '84-1469852');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M852252399-1', 'Theophylline', 7, 80, 0, 0, to_date('2016-12-26', 'yyyy-mm-dd'), 'Children', 1, '03-1059950');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M696477351-7', 'Ultra Care-aid Sanitizer Antiseptic Hand Sanitizer ', 1, 50, 0, 0, to_date('2016-09-05', 'yyyy-mm-dd'), 'Horror', 0, null);
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M359488090-7', 'Neomycin Polymyxin B Sulfates and Dexamethasone', 6, 62, 0, 0, to_date('2016-08-02', 'yyyy-mm-dd'), 'Science Fiction', 1, '43-8426902');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M927036435-6', 'Ranitidine', 1, 65, 0, 0, to_date('2017-02-12', 'yyyy-mm-dd'), 'Science Fiction', 1, '50-4392985');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M918030003-0', 'Koh Gen DoTriple Lighting', 9, 71, 0, 0, to_date('2016-09-24', 'yyyy-mm-dd'), 'Romance', 1, '43-8426902');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M896021191-5', 'Cefoxitin', 7, 73, 0, 0, to_date('2016-06-03', 'yyyy-mm-dd'), 'Adventure', 1, '03-1059950');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M906274900-3', 'LBEL COULEUR LUXE AMPLIFIER XP', 7, 36, 0, 0, to_date('2016-07-16', 'yyyy-mm-dd'), 'Thriller', 1, '43-8426902');
...
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M128892382-1', 'Aspirin', 9, 9, 0, 0, to_date('2016-09-28', 'yyyy-mm-dd'), 'Children', 1, '50-4392985');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M774683988-6', 'Isoniazid', 4, 26, 0, 0, to_date('2017-04-04', 'yyyy-mm-dd'), 'Horror', 1, '43-8426902');
insert into Movies (MovieID, Title, price, rating, totalInStock, TotalAvailable, release_date, genre, isonspecial, specialid) values ('M129392377-X', 'Armour Thyroid', 10, 5, 0, 0, to_date('2017-04-16', 'yyyy-mm-dd'), 'Romance', 1, '50-4392985');
...
--shipments                                                                                                                    '
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S1',  'M831184771-1',to_date('2017-03-14', 'yyyy-mm-dd'), '2 Dakota Way', 'Cameroon', 'E94-9771106', 16);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S2',  'M809968032-4',to_date('2016-10-01', 'yyyy-mm-dd'), '2 Eggendart Trail', 'Japan', 'E94-9771106', 21);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S3',  'M174780365-0',to_date('2016-05-07', 'yyyy-mm-dd'), '4 Continental Terrace', 'Venezuela', 'E94-9771106', 32);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S4',  'M885572416-9',to_date('2016-07-21', 'yyyy-mm-dd'), '78 Straubel Avenue', 'China', 'E94-9771106', 23);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S5',  'M117755981-1',to_date('2016-12-10', 'yyyy-mm-dd'),'1 International Road', 'Russia', 'E94-9771106', 19);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S6',  'M050440730-9',to_date('2017-01-26', 'yyyy-mm-dd'), '00 Shopko Road', 'Colombia', 'E94-9771106', 20);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S7',  'M199313177-9',to_date('2016-08-20', 'yyyy-mm-dd'), '98048 Swallow Plaza', 'Indonesia', 'E94-9771106', 41);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S8',  'M866473020-2',to_date('2017-02-28', 'yyyy-mm-dd'), '31751 New Castle Way', 'Argentina', 'E94-9771106', 34);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S9',  'M925789324-3',to_date('2016-12-10', 'yyyy-mm-dd'), '6052 Bellgrove Hill', 'Brazil', 'E94-9771106', 42);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S10', 'M374688018-1',to_date('2017-03-27', 'yyyy-mm-dd'), '67 Caliangt Plaza', 'Indonesia', 'E94-9771106', 21);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S11', 'M696981365-7',to_date('2017-01-28', 'yyyy-mm-dd'), '011 American Circle', 'Egypt', 'E94-9771106', 48);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S12', 'M211487951-8',to_date('2016-08-10', 'yyyy-mm-dd'), '75996 Corscot Hill', 'Argentina', 'E94-9771106', 39);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S13', 'M757360676-1',to_date('2016-12-04', 'yyyy-mm-dd'), '27648 Del Mar Hill', 'France', 'E94-9771106', 49);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S14', 'M488892791-X',to_date('2016-06-18', 'yyyy-mm-dd'), '8800 Stoughton Parkway', 'China', 'E94-9771106', 27);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S15', 'M684103662-X',to_date('2016-09-17', 'yyyy-mm-dd'), '0 Tony Way', 'China', 'E94-9771106', 50);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S16', 'M190607278-7',to_date('2016-05-24', 'yyyy-mm-dd'), '070 Doe Crossing Park', 'Ukraine', 'E94-9771106', 42);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S17', 'M759287079-7',to_date('2017-03-17', 'yyyy-mm-dd'), '5116 Larry Center', 'China', 'E94-9771106', 21);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S18', 'M322798261-7',to_date('2016-07-20', 'yyyy-mm-dd'), '5210 Waywood Alley', 'Philippines', 'E94-9771106', 15);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S19', 'M233532223-0',to_date('2017-02-22', 'yyyy-mm-dd'), '7 Barby Avenue', 'China', 'E94-9771106', 16);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S20', 'M267996024-6',to_date('2016-06-30', 'yyyy-mm-dd'), '1 Crownhardt Road', 'Nigeria', 'E94-9771106', 12);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S21', 'M924122750-8',to_date('2016-07-20', 'yyyy-mm-dd'), '064 Loeprich Road', 'Philippines', 'E94-9771106', 37);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S22', 'M217992193-4',to_date('2016-09-18', 'yyyy-mm-dd'),'75 Warrior Court', 'Czech Republic', 'E94-9771106', 44);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S23', 'M654261916-X',to_date('2017-03-23', 'yyyy-mm-dd'), '00852 Brentwood Road', 'Tunisia', 'E94-9771106', 46);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S24', 'M552063168-9',to_date('2016-07-22', 'yyyy-mm-dd'), '94 Parkside Plaza', 'China', 'E94-9771106', 24);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S25', 'M820207425-8',to_date('2017-01-03', 'yyyy-mm-dd'), '393 Riverside Avenue', 'United States', 'E94-9771106', 31);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S26', 'M395937266-3',to_date('2017-04-10', 'yyyy-mm-dd'), '69754 Raven Road', 'United States', 'E94-9771106', 20);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S27', 'M505705799-5',to_date('2016-09-22', 'yyyy-mm-dd'), '969 Lighthouse Bay Junction', 'China', 'E94-9771106', 48);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S28', 'M287175663-5',to_date('2016-08-30', 'yyyy-mm-dd'), '185 Kipling Circle', 'Indonesia', 'E94-9771106', 35);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S29', 'M622722806-0',to_date('2016-08-31', 'yyyy-mm-dd'), '70686 Garrison Pass', 'Albania', 'E94-9771106', 18);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S30', 'M124228302-1',to_date('2016-06-14', 'yyyy-mm-dd'), '9437 Schmedeman Plaza', 'China', 'E94-9771106', 50);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S31', 'M699577798-0',to_date('2017-03-18', 'yyyy-mm-dd'), '61793 Saint Paul Road', 'Poland', 'E94-9771106', 16);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S32', 'M279690940-9',to_date('2016-07-23', 'yyyy-mm-dd'), '97 School Park', 'Mexico', 'E94-9771106', 36);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S33', 'M919256288-4',to_date('2016-11-02', 'yyyy-mm-dd'), '7842 Swallow Street', 'Pakistan', 'E94-9771106', 24);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S34', 'M179390592-4',to_date('2016-04-27', 'yyyy-mm-dd'), '4206 Jay Center', 'Philippines', 'E94-9771106', 50);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S35', 'M073380619-8',to_date('2016-05-23', 'yyyy-mm-dd'), '96565 Anzinger Plaza', 'Vietnam', 'E94-9771106', 17);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S36', 'M450207868-9',to_date('2017-03-25', 'yyyy-mm-dd'), '969 Superior Crossing', 'Luxembourg', 'E94-9771106', 28);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S37', 'M635243850-4',to_date('2016-06-11', 'yyyy-mm-dd'), '89301 Kedzie Drive', 'Indonesia', 'E94-9771106', 31);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S38', 'M145499305-7',to_date('2016-11-02', 'yyyy-mm-dd'), '4 Rockefeller Place', 'Honduras', 'E94-9771106', 37);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S39', 'M818931110-7',to_date('2016-12-16', 'yyyy-mm-dd'), '1234 Melrose Point', 'Portugal', 'E94-9771106', 14);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S40', 'M411281165-9',to_date('2017-01-22', 'yyyy-mm-dd'), '0 Morning Alley', 'Turkmenistan', 'E94-9771106', 23);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S41', 'M211100485-5',to_date('2017-03-11', 'yyyy-mm-dd'), '73581 Miller Place', 'French Polynesia', 'E94-9771106', 28);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S42', 'M503453138-0',to_date('2017-04-01', 'yyyy-mm-dd'), '83333 Annamark Parkway', 'Russia', 'E94-9771106', 41);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S43', 'M477233437-8',to_date('2016-06-19', 'yyyy-mm-dd'), '3838 Arizona Parkway', 'Indonesia', 'E94-9771106', 48);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S44', 'M507774661-3',to_date('2017-01-17', 'yyyy-mm-dd'), '71 Westridge Crossing', 'Japan', 'E94-9771106', 41);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S45', 'M854503307-9',to_date('2017-01-12', 'yyyy-mm-dd'), '9 Dennis Plaza', 'Indonesia', 'E94-9771106', 32);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S46', 'M660157314-0',to_date('2016-07-21', 'yyyy-mm-dd'), '66645 Killdeer Drive', 'China', 'E94-9771106', 42);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S47', 'M712773188-8',to_date('2016-05-29', 'yyyy-mm-dd'), '7 Meadow Vale Street', 'Norway', 'E94-9771106', 31);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S48', 'M052454358-5',to_date('2016-11-10', 'yyyy-mm-dd'), '59407 Warner Hill', 'China', 'E94-9771106', 25);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S49', 'M148142096-8',to_date('2017-01-10', 'yyyy-mm-dd'), '21 Park Meadow Junction', 'Indonesia', 'E94-9771106', 42);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S50', 'M645194151-4',to_date('2017-01-09', 'yyyy-mm-dd'), '36 Ridgeview Parkway', 'Indonesia', 'E94-9771106', 37);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S51', 'M405494574-0',to_date('2017-02-20', 'yyyy-mm-dd'), '728 Jana Hill', 'China', 'E94-9771106', 48);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S52', 'M187439060-6',to_date('2016-11-21', 'yyyy-mm-dd'), '92049 Northfield Way', 'Greece', 'E94-9771106', 25);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S53', 'M902935049-0',to_date('2016-07-02', 'yyyy-mm-dd'),'2004 Londonderry Circle', 'Philippines', 'E94-9771106', 23);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S54', 'M486843403-9',to_date('2016-04-26', 'yyyy-mm-dd'),'66 Superior Circle', 'Greece', 'E94-9771106', 37);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S55', 'M952545687-0',to_date('2016-10-18', 'yyyy-mm-dd'),'35593 Stang Plaza', 'Nigeria', 'E94-9771106', 26);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S56', 'M945119177-1',to_date('2016-11-01', 'yyyy-mm-dd'), '0014 Waubesa Crossing', 'Serbia', 'E94-9771106', 11);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S57', 'M348242824-7',to_date('2016-12-01', 'yyyy-mm-dd'), '71768 Crescent Oaks Park', 'Netherlands', 'E94-9771106', 13);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S58', 'M891216517-8',to_date('2016-12-15', 'yyyy-mm-dd'), '4167 Maywood Center', 'Croatia', 'E94-9771106', 29);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S59', 'M872602512-4',to_date('2017-03-31', 'yyyy-mm-dd'), '1135 Crescent Oaks Parkway', 'Brazil', 'E94-9771106', 40);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S60', 'M660880559-4',to_date('2017-03-28', 'yyyy-mm-dd'),'20 Autumn Leaf Avenue', 'Indonesia', 'E94-9771106', 44);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S61', 'M548194364-6',to_date('2017-02-01', 'yyyy-mm-dd'), '4405 Bashford Avenue', 'Sweden', 'E94-9771106', 32);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S62', 'M740809371-0',to_date('2016-12-28', 'yyyy-mm-dd'), '5 Shelley Hill', 'Poland', 'E94-9771106', 16);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S63', 'M495916945-1',to_date('2016-09-20', 'yyyy-mm-dd'), '49 Susan Center', 'Indonesia', 'E94-9771106', 16);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S64', 'M968149820-8',to_date('2016-09-22', 'yyyy-mm-dd'), '56726 Londonderry Alley', 'Philippines', 'E94-9771106', 12);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S65', 'M230640306-6',to_date('2016-04-28', 'yyyy-mm-dd'), '70 Prairieview Terrace', 'China', 'E94-9771106', 27);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S66', 'M317780210-6',to_date('2017-02-01', 'yyyy-mm-dd'), '86776 Reinke Terrace', 'Indonesia', 'E94-9771106', 43);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S67', 'M707427907-2',to_date('2016-05-29', 'yyyy-mm-dd'), '414 Dryden Way', 'France', 'E94-9771106', 13);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S68', 'M407884426-X',to_date('2017-03-16', 'yyyy-mm-dd'), '5443 Rigney Hill', 'China', 'E94-9771106', 22);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S69', 'M898435796-0',to_date('2016-11-02', 'yyyy-mm-dd'), '0419 Bay Trail', 'Philippines', 'E94-9771106', 21);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S70', 'M412093618-X',to_date('2016-11-16', 'yyyy-mm-dd'),'82359 Quincy Court', 'Ukraine', 'E94-9771106', 33);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S71', 'M235500150-2',to_date('2016-09-04', 'yyyy-mm-dd'), '8 Brickson Park Lane', 'China', 'E94-9771106', 40);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S72', 'M535405514-8',to_date('2016-05-26', 'yyyy-mm-dd'), '5 Fairview Avenue', 'Germany', 'E94-9771106', 11);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S73', 'M111592155-X',to_date('2016-11-06', 'yyyy-mm-dd'), '69218 Lawn Lane', 'China', 'E94-9771106', 10);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S74', 'M014609733-5',to_date('2017-03-03', 'yyyy-mm-dd'), '339 Sundown Street', 'Indonesia', 'E94-9771106', 24);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S75', 'M978688451-5',to_date('2016-06-13', 'yyyy-mm-dd'), '04 Thackeray Point', 'United States', 'E94-9771106', 13);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S76', 'M392774450-6',to_date('2017-01-04', 'yyyy-mm-dd'), '54 Kenwood Point', 'China', 'E94-9771106', 39);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S77', 'M878461521-4',to_date('2016-09-21', 'yyyy-mm-dd'), '6860 Florence Terrace', 'Russia', 'E94-9771106', 27);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S78', 'M417541592-0',to_date('2017-02-19', 'yyyy-mm-dd'), '77 Corben Road', 'Ukraine', 'E94-9771106', 39);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S79', 'M502940406-6',to_date('2017-01-29', 'yyyy-mm-dd'), '96764 Roth Road', 'Italy', 'E94-9771106', 50);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S80', 'M905986669-X',to_date('2016-10-28', 'yyyy-mm-dd'), '361 Stoughton Plaza', 'Portugal', 'E94-9771106', 29);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S81', 'M583329212-3',to_date('2016-05-04', 'yyyy-mm-dd'), '9517 Michigan Hill', 'Brazil', 'E94-9771106', 47);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S82', 'M468733029-0',to_date('2016-11-25', 'yyyy-mm-dd'), '57828 Express Avenue', 'Indonesia', 'E94-9771106', 49);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S83', 'M467080207-0',to_date('2016-06-21', 'yyyy-mm-dd'), '36 Waywood Hill', 'Italy', 'E94-9771106', 45);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S84', 'M852252399-1',to_date('2016-12-05', 'yyyy-mm-dd'),'1883 Mifflin Circle', 'Indonesia', 'E94-9771106', 40);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S85', 'M696477351-7',to_date('2016-09-11', 'yyyy-mm-dd'), '989 Marquette Junction', 'China', 'E94-9771106', 45);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S86', 'M665636013-0',to_date('2017-03-30', 'yyyy-mm-dd'), '00 Hoffman Park', 'Finland', 'E94-9771106', 44);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S87', 'M633729999-X',to_date('2016-12-30', 'yyyy-mm-dd'),'2 Oak Junction', 'United States', 'E94-9771106', 45);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S88', 'M359488090-7',to_date('2017-03-11', 'yyyy-mm-dd'), '37 Brickson Park Court', 'Kazakhstan', 'E94-9771106', 22);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S89', 'M927036435-6',to_date('2016-11-11', 'yyyy-mm-dd'), '0985 Springview Trail', 'Poland', 'E94-9771106', 29);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S90', 'M403209090-4',to_date('2016-12-24', 'yyyy-mm-dd'), '366 Cambridge Trail', 'Greece', 'E94-9771106', 17);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S91', 'M918030003-0',to_date('2017-03-07', 'yyyy-mm-dd'),'619 Straubel Alley', 'Portugal', 'E94-9771106', 30);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S92', 'M896021191-5',to_date('2016-11-13', 'yyyy-mm-dd'),'11 Rockefeller Road', 'Ukraine', 'E94-9771106', 41);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S93', 'M906274900-3',to_date('2016-10-21', 'yyyy-mm-dd'), '4196 Kim Hill', 'Russia', 'E94-9771106', 31);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S94', 'M676422889-2',to_date('2016-04-29', 'yyyy-mm-dd'), '1691 Mockingbird Alley', 'Indonesia', 'E94-9771106', 17);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S95', 'M455417584-7',to_date('2017-01-07', 'yyyy-mm-dd'), '2 Evergreen Plaza', 'Tunisia', 'E94-9771106', 18);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S96', 'M128892382-1',to_date('2016-06-19', 'yyyy-mm-dd'), '23772 American Ash Center', 'Croatia', 'E94-9771106', 40);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S97', 'M774683988-6',to_date('2016-09-26', 'yyyy-mm-dd'), '44596 Browning Place', 'Sweden', 'E94-9771106', 39);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S98', 'M129392377-X',to_date('2017-03-29', 'yyyy-mm-dd'),'43234 Milwaukee Parkway', 'Poland', 'E94-9771106', 39);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S99', 'M541359309-0',to_date('2016-09-15', 'yyyy-mm-dd'), '2 Warrior Center', 'Indonesia', 'E94-9771106', 20);
insert into shipments (shipmentid, movieid, ship_date, ship_street, ship_country, employeeid, shipmentquantity) values ('S100','M372530453-X',to_date('2016-11-12', 'yyyy-mm-dd'), '74948 Manley Plaza', 'Chile', 'E94-9771106', 16);

--rentals
insert into rentals (rentalid, customerid, employeeid, movieid, date_rented, return_date, price, specialid, paid, returned) values ('R126856643-8', 'C625241504-9', 'E94-9771106','M831184771-1', to_date('2007-09-20', 'yyyy-mm-dd'), to_date('2013-01-29', 'yyyy-mm-dd'), 36, '03-1059950', 0, 0);
insert into rentals (rentalid, customerid, employeeid, movieid, date_rented, return_date, price, specialid, paid, returned) values ('R701339923-X', 'C158114470-9', 'E94-9771106','M809968032-4', to_date('2007-01-27', 'yyyy-mm-dd'), to_date('2010-11-02', 'yyyy-mm-dd'), 20, '03-1059950', 0, 0);
insert into rentals (rentalid, customerid, employeeid, movieid, date_rented, return_date, price, specialid, paid, returned) values ('R263131225-2', 'C099701617-5', 'E94-9771106','M174780365-0', to_date('2014-02-02', 'yyyy-mm-dd'), to_date('2015-06-14', 'yyyy-mm-dd'), 19, '03-1059950', 0, 0);
insert into rentals (rentalid, customerid, employeeid, movieid, date_rented, return_date, price, specialid, paid, returned) values ('R115115634-5', 'C450905054-2', 'E94-9771106','M885572416-9',  to_date('2013-07-17', 'yyyy-mm-dd'), to_date('2005-04-19', 'yyyy-mm-dd'), 34, '03-1059950', 0, 0);
insert into rentals (rentalid, customerid, employeeid, movieid, date_rented, return_date, price, specialid, paid, returned) values ('R035945460-7', 'C976665713-0', 'E94-9771106','M117755981-1',  to_date('2014-10-13', 'yyyy-mm-dd'), to_date('2012-12-22', 'yyyy-mm-dd'), 11, '03-1059950', 1, 0);
...
insert into movieactors (actorid, movieid) values ('A48-9002954', 'M831184771-1');
insert into movieactors (actorid, movieid) values ('A65-1773695', 'M809968032-4');
insert into movieactors (actorid, movieid) values ('A40-1161197', 'M174780365-0');
insert into movieactors (actorid, movieid) values ('A27-2160889', 'M885572416-9');
insert into movieactors (actorid, movieid) values ('A31-9784973', 'M117755981-1');
insert into movieactors (actorid, movieid) values ('A33-7040519', 'M050440730-9');
insert into movieactors (actorid, movieid) values ('A62-8454644', 'M199313177-9');
insert into movieactors (actorid, movieid) values ('A07-2483388', 'M866473020-2');
insert into movieactors (actorid, movieid) values ('A30-2447763', 'M925789324-3');
insert into movieactors (actorid, movieid) values ('A60-1955047', 'M374688018-1');
insert into movieactors (actorid, movieid) values ('A06-9357192', 'M696981365-7');
insert into movieactors (actorid, movieid) values ('A39-9651342', 'M211487951-8');
insert into movieactors (actorid, movieid) values ('A63-2846037', 'M757360676-1');
insert into movieactors (actorid, movieid) values ('A53-4283011', 'M488892791-X');
insert into movieactors (actorid, movieid) values ('A76-8127180', 'M684103662-X');
insert into movieactors (actorid, movieid) values ('A65-4070520', 'M190607278-7');
insert into movieactors (actorid, movieid) values ('A85-9687546', 'M759287079-7');
insert into movieactors (actorid, movieid) values ('A34-9304923', 'M322798261-7');
insert into movieactors (actorid, movieid) values ('A90-7777042', 'M233532223-0');
insert into movieactors (actorid, movieid) values ('A39-1850089', 'M267996024-6');
insert into movieactors (actorid, movieid) values ('A53-7454892', 'M924122750-8');
insert into movieactors (actorid, movieid) values ('A36-3921693', 'M217992193-4');
insert into movieactors (actorid, movieid) values ('A03-3030021', 'M654261916-X');
insert into movieactors (actorid, movieid) values ('A99-6803668', 'M552063168-9');
insert into movieactors (actorid, movieid) values ('A81-2673545', 'M820207425-8');
insert into movieactors (actorid, movieid) values ('A07-7978407', 'M395937266-3');
insert into movieactors (actorid, movieid) values ('A63-9738818', 'M505705799-5');
insert into movieactors (actorid, movieid) values ('A16-0680939', 'M287175663-5');
insert into movieactors (actorid, movieid) values ('A48-4018681', 'M622722806-0');
insert into movieactors (actorid, movieid) values ('A55-3993946', 'M124228302-1');
insert into movieactors (actorid, movieid) values ('A37-0827296', 'M699577798-0');
insert into movieactors (actorid, movieid) values ('A60-0300796', 'M279690940-9');
insert into movieactors (actorid, movieid) values ('A49-5936395', 'M919256288-4');
insert into movieactors (actorid, movieid) values ('A85-5102149', 'M179390592-4');
insert into movieactors (actorid, movieid) values ('A19-7469409', 'M073380619-8');
insert into movieactors (actorid, movieid) values ('A03-2059515', 'M450207868-9');
insert into movieactors (actorid, movieid) values ('A17-2840227', 'M635243850-4');
insert into movieactors (actorid, movieid) values ('A17-1106101', 'M145499305-7');
insert into movieactors (actorid, movieid) values ('A14-3106568', 'M818931110-7');
insert into movieactors (actorid, movieid) values ('A48-9002954', 'M411281165-9');
insert into movieactors (actorid, movieid) values ('A65-1773695', 'M211100485-5');
insert into movieactors (actorid, movieid) values ('A40-1161197', 'M503453138-0');
insert into movieactors (actorid, movieid) values ('A27-2160889', 'M477233437-8');
insert into movieactors (actorid, movieid) values ('A31-9784973', 'M507774661-3');
insert into movieactors (actorid, movieid) values ('A33-7040519', 'M854503307-9');
insert into movieactors (actorid, movieid) values ('A62-8454644', 'M660157314-0');
insert into movieactors (actorid, movieid) values ('A07-2483388', 'M712773188-8');
insert into movieactors (actorid, movieid) values ('A30-2447763', 'M052454358-5');
insert into movieactors (actorid, movieid) values ('A60-1955047', 'M148142096-8');
insert into movieactors (actorid, movieid) values ('A06-9357192', 'M645194151-4');
insert into movieactors (actorid, movieid) values ('A39-9651342', 'M405494574-0');
insert into movieactors (actorid, movieid) values ('A63-2846037', 'M187439060-6');
insert into movieactors (actorid, movieid) values ('A53-4283011', 'M902935049-0');
insert into movieactors (actorid, movieid) values ('A76-8127180', 'M486843403-9');
insert into movieactors (actorid, movieid) values ('A65-4070520', 'M952545687-0');
insert into movieactors (actorid, movieid) values ('A85-9687546', 'M945119177-1');
insert into movieactors (actorid, movieid) values ('A34-9304923', 'M348242824-7');
insert into movieactors (actorid, movieid) values ('A90-7777042', 'M891216517-8');
insert into movieactors (actorid, movieid) values ('A39-1850089', 'M872602512-4');
insert into movieactors (actorid, movieid) values ('A53-7454892', 'M660880559-4');
insert into movieactors (actorid, movieid) values ('A36-3921693', 'M548194364-6');
insert into movieactors (actorid, movieid) values ('A03-3030021', 'M740809371-0');
insert into movieactors (actorid, movieid) values ('A99-6803668', 'M495916945-1');
insert into movieactors (actorid, movieid) values ('A81-2673545', 'M968149820-8');
insert into movieactors (actorid, movieid) values ('A07-7978407', 'M230640306-6');
insert into movieactors (actorid, movieid) values ('A63-9738818', 'M317780210-6');
insert into movieactors (actorid, movieid) values ('A16-0680939', 'M707427907-2');
insert into movieactors (actorid, movieid) values ('A48-4018681', 'M407884426-X');
insert into movieactors (actorid, movieid) values ('A55-3993946', 'M898435796-0');
insert into movieactors (actorid, movieid) values ('A37-0827296', 'M412093618-X');
insert into movieactors (actorid, movieid) values ('A48-9002954', 'M235500150-2');
insert into movieactors (actorid, movieid) values ('A65-1773695', 'M535405514-8');
insert into movieactors (actorid, movieid) values ('A40-1161197', 'M111592155-X');
insert into movieactors (actorid, movieid) values ('A27-2160889', 'M014609733-5');
insert into movieactors (actorid, movieid) values ('A31-9784973', 'M978688451-5');
insert into movieactors (actorid, movieid) values ('A33-7040519', 'M392774450-6');
insert into movieactors (actorid, movieid) values ('A62-8454644', 'M878461521-4');
insert into movieactors (actorid, movieid) values ('A07-2483388', 'M417541592-0');
insert into movieactors (actorid, movieid) values ('A30-2447763', 'M502940406-6');
insert into movieactors (actorid, movieid) values ('A60-1955047', 'M905986669-X');
insert into movieactors (actorid, movieid) values ('A06-9357192', 'M583329212-3');
insert into movieactors (actorid, movieid) values ('A39-9651342', 'M468733029-0');
insert into movieactors (actorid, movieid) values ('A63-2846037', 'M467080207-0');
insert into movieactors (actorid, movieid) values ('A53-4283011', 'M852252399-1');
insert into movieactors (actorid, movieid) values ('A76-8127180', 'M696477351-7');
insert into movieactors (actorid, movieid) values ('A65-4070520', 'M665636013-0');
insert into movieactors (actorid, movieid) values ('A85-9687546', 'M633729999-X');
insert into movieactors (actorid, movieid) values ('A34-9304923', 'M359488090-7');
insert into movieactors (actorid, movieid) values ('A90-7777042', 'M927036435-6');
insert into movieactors (actorid, movieid) values ('A39-1850089', 'M403209090-4');
insert into movieactors (actorid, movieid) values ('A53-7454892', 'M918030003-0');
insert into movieactors (actorid, movieid) values ('A36-3921693', 'M896021191-5');
insert into movieactors (actorid, movieid) values ('A03-3030021', 'M906274900-3');
insert into movieactors (actorid, movieid) values ('A99-6803668', 'M676422889-2');
insert into movieactors (actorid, movieid) values ('A81-2673545', 'M455417584-7');
insert into movieactors (actorid, movieid) values ('A07-7978407', 'M128892382-1');
insert into movieactors (actorid, movieid) values ('A63-9738818', 'M774683988-6');
insert into movieactors (actorid, movieid) values ('A16-0680939', 'M129392377-X');
insert into movieactors (actorid, movieid) values ('A48-4018681', 'M541359309-0');
insert into movieactors (actorid, movieid) values ('A55-3993946', 'M372530453-X');
